    ...
    def init = { servletContext ->
        ...
        environments {
            development {
                ...
                new Ball(manufacturer: manufacturer3D, name: 'type 543', size: Ball.Size.m, surface: Ball.Surface.l, shore: 60, speed: 45, weight: 50).save(failOnError: true)
                new Ball(manufacturer: manufacturer3D, name: '50 Jahre 1. MGC Köln', size: Ball.Size.m, surface: Ball.Surface.x, shore: 55, speed: 33, weight: 55).save(failOnError: true)
                new Ball(manufacturer: manufacturerBM, name: 'H5', size: Ball.Size.k, surface: Ball.Surface.l, shore: 45, speed: 5.5, weight: 35).save(failOnError: true)
                new Ball(manufacturer: manufacturerBM, name: 'B4', size: Ball.Size.k, surface: Ball.Surface.l, shore: 64, speed: 48, weight: 39).save(failOnError: true)
                new Ball(manufacturer: manufacturerReis, name: 'BO 1', size: Ball.Size.k, surface: Ball.Surface.l, shore: 45, speed: 45, weight: 60).save(failOnError: true)
                new Ball(manufacturer: manufacturer3D, name: '50 Jahre 1. MGC Köln', size: Ball.Size.m, surface: Ball.Surface.l, shore: 55, speed: 33, weight: 55).save(failOnError: true)
                new Ball(manufacturer: manufacturer3D, name: 'type 333', size: Ball.Size.k, surface: Ball.Surface.l, shore: 55, speed: 33, weight: 55).save(failOnError: true)
                new Ball(manufacturer: manufacturer3D, name: 'Guppy', size: Ball.Size.k, surface: Ball.Surface.l, shore: 55, speed: 33, weight: 55).save(failOnError: true)
                new Ball(manufacturer: manufacturer3D, name: '50 Jahre 1. MGC Köln', size: Ball.Size.m, surface: Ball.Surface.r, shore: 55, speed: 33, weight: 55).save(failOnError: true)
